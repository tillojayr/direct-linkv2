...
<body>
  ...
  <nav style="height: 80px" class="search-button mb-5 d-flex justify-content-between align-items-center bg-primary">
    <div class="d-flex">
      <input type="text" id="search_job" name="search_job" class="form-control form-control-lg" required
        style="width: 400px" />
    ...
    <div class="navbar-links">
      <a href=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
          class="size-10 text-white" style="height: 3rem; width: 3rem">
          <path
      ...
      <a href="employer-profile.php"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
          stroke-width="1.5" stroke="currentColor" class="size-10 text-white" style="height: 3rem; width: 3rem">
  ...
  <div class="container mt-4">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12 mb-sm-5 px-5 border-end border-dark border-2" id="job_posting_container">
        ...
        <button class="btn col-12 mt-4 btn-secondary" id="add_job_posting_btn" type="button">Add Job Posting</button>
        <div id="job_posting_container"></div>
      </div>
  ...
  <!-- Modal -->
  <div class="modal fade" id="add_job_posting_modal" tabindex="-1" aria-labelledby="exampleModalLabel1"
    aria-hidden="true">
